...
= 1.9.7 =
* Corrected how get-post describes posts with no block markup: they are no longer said to predate the block editor, and their content is no longer assumed to be HTML. Wording only.
